...
const ROCK = (function () {
  ...
  /* ---------------------------------------------------------------------
     ...
     Handbook, 3rd ed. (2020), mineral tables in Appendix A. Clay is the awkward one: it is not a
  ...
  /* ---------------------------------------------------------------------
     ...
     with the usual shortcut:
       ...
       - The straight-ray estimate, tan(theta) = (x/2)/z, ignores refraction.
         ...
         away from vertical on the way down. It is therefore steeper than the
         straight line near the source and flatter than it near the target, and
         to cover the same horizontal distance it has to arrive at the reflector
         at a LARGER incidence angle than the straight-ray value. Several
         degrees at short offset, and well over ten degrees at long offset.
