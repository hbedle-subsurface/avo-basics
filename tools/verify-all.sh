...
set -e
cd "$(dirname "$0")/.."
MODULES="beyond-normal-incidence rocks-and-stiffness the-echo start-here rock-to-trace same-amplitude add-offset intercept-gradient reading-a-gather what-survives"
...
for f in verify-prose-m00 verify-prose-m01-rock verify-prose-m01 verify-prose verify-prose-m2 verify-prose-m3 verify-prose-m4 verify-prose-m5 verify-prose-m6; do
