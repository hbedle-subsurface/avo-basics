/* Every number quoted in module 07's prose, re-derived by driving the page and
...
console.log('\nMODULE 07 — prose against the running page\n');
...
console.log('\n' + (bad ? bad + ' MISMATCHES' : 'every number in module 07 matches the page') + '\n');
