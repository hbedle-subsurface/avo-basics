/* Every number module 08's prose quotes, re-derived by driving the page.
...
console.log('\nMODULE 08 — prose against the running page\n');
...
console.log('\n' + (bad ? bad + ' MISMATCHES' : 'every number in module 08 matches the page') + '\n');
