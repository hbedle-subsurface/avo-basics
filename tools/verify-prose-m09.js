/* Every number module 09's prose quotes, re-derived by driving the page.
...
console.log('\nMODULE 09 — prose against the running page\n');
...
console.log('\n' + (bad ? bad + ' MISMATCHES' : 'every number in module 09 matches the page') + '\n');
